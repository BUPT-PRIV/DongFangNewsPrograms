...
import logging
from transformers1.modeling_gpt2 import GPT2Config, GPT2LMHeadModel
...
def set_interact_args():
    ...
    parser.add_argument('--seed', type=int, default=True, help='设置种子用于生成随机数，以使得训练的结果是确定的')
