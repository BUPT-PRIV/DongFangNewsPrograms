...
from transformers1.commands import BaseTransformersCLICommand
...
class ConvertCommand(BaseTransformersCLICommand):
    ...
    def run(self):
        if self._model_type == "bert":
            try:
                from transformers1.convert_bert_original_tf_checkpoint_to_pytorch import (
            ...
            from transformers1.convert_openai_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from transformers1.convert_transfo_xl_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from transformers1.convert_gpt2_original_tf_checkpoint_to_pytorch import (
            ...
            try:
                from transformers1.convert_xlnet_original_tf_checkpoint_to_pytorch import (
            ...
            from transformers1.convert_xlm_original_pytorch_checkpoint_to_pytorch import (
