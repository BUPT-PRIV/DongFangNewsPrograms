...
from transformers1 import SingleSentenceClassificationProcessor as Processor
from transformers1 import TextClassificationPipeline, is_tf_available, is_torch_available
