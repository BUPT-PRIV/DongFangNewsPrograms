...
from transformers1.configuration_albert import AlbertConfig
from transformers1.modeling_bert import ACT2FN, BertEmbeddings, BertSelfAttention, prune_linear_layer
from transformers1.modeling_utils import PreTrainedModel
